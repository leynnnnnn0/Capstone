...
/**
* @see \App\Http\Controllers\WorkJobController::createFromAppointment
* @see app/Http/Controllers/WorkJobController.php:70
* @route '/appointments/{appointment}/work-job'
*/
export const createFromAppointment = (args: { appointment: number | { id: number } } | [appointment: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: createFromAppointment.url(args, options),
    method: 'get',
})

createFromAppointment.definition = {
    methods: ["get","head"],
...
* @route '/appointments/{appointment}/work-job'
*/
createFromAppointment.url = (args: { appointment: number | { id: number } } | [appointment: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
    ...
    return createFromAppointment.definition.url
...
* @route '/appointments/{appointment}/work-job'
*/
createFromAppointment.get = (args: { appointment: number | { id: number } } | [appointment: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: createFromAppointment.url(args, options),
    method: 'get',
})
...
* @route '/appointments/{appointment}/work-job'
*/
createFromAppointment.head = (args: { appointment: number | { id: number } } | [appointment: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: createFromAppointment.url(args, options),
    method: 'head',
})
...
* @route '/appointments/{appointment}/work-job'
*/
const createFromAppointmentForm = (args: { appointment: number | { id: number } } | [appointment: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: createFromAppointment.url(args, options),
    method: 'get',
})
...
* @route '/appointments/{appointment}/work-job'
*/
createFromAppointmentForm.get = (args: { appointment: number | { id: number } } | [appointment: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: createFromAppointment.url(args, options),
    method: 'get',
})
...
* @route '/appointments/{appointment}/work-job'
*/
createFromAppointmentForm.head = (args: { appointment: number | { id: number } } | [appointment: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: createFromAppointment.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
createFromAppointment.form = createFromAppointmentForm

/**
* @see \App\Http\Controllers\WorkJobController::markInProgress
* @see app/Http/Controllers/WorkJobController.php:160
* @route '/work-jobs/{workJob}/in-progress'
*/
export const markInProgress = (args: { workJob: number | { id: number } } | [workJob: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: markInProgress.url(args, options),
    method: 'put',
})

markInProgress.definition = {
    methods: ["put"],
...
* @route '/work-jobs/{workJob}/in-progress'
*/
markInProgress.url = (args: { workJob: number | { id: number } } | [workJob: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { workJob: args }
    }
    ...
    return markInProgress.definition.url
            .replace('{workJob}', parsedArgs.workJob.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/work-jobs/{workJob}/in-progress'
*/
markInProgress.put = (args: { workJob: number | { id: number } } | [workJob: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: markInProgress.url(args, options),
    method: 'put',
})
...
* @route '/work-jobs/{workJob}/in-progress'
*/
const markInProgressForm = (args: { workJob: number | { id: number } } | [workJob: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: markInProgress.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PUT',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
* @route '/work-jobs/{workJob}/in-progress'
*/
markInProgressForm.put = (args: { workJob: number | { id: number } } | [workJob: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: markInProgress.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PUT',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
markInProgress.form = markInProgressForm
...
const WorkJobController = { index, create, store, show, createFromAppointment, markInProgress, complete, cancel }

export default WorkJobController