...
type FieldErrors = Partial<Record<keyof CustomerAppointmentForm | "form", string>>;
...
export default function AppointmentForm({
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (!parsed.success) {
      setErrors(zodIssuesToFieldErrors<keyof CustomerAppointmentForm | "form">(parsed.error.issues));
      return;
    }
