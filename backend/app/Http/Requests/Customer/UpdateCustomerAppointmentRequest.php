...
class UpdateCustomerAppointmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'preferred_date' => ['required', 'date', 'date_format:Y-m-d', 'after_or_equal:today'],
            ...
            'service_type_other' => ['nullable', 'string', 'max:255', Rule::requiredIf(fn () => $this->input('service_type') === 'other')],
