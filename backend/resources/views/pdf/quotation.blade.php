    ...
    <style>
        * {
        ...
        @media print {
            ...
            /* Keep padding on the wrapper when printing */
            .page-wrapper {
                padding: 0 !important;
        ...
        /* Force background colors through print */
        .bg-ink {
...
<body class="bg-white text-[#111111]" style="font-family:'Source Sans 3',sans-serif; font-size:10.5px;">
    ...
    <div class="page-wrapper max-w-[860px] mx-auto px-12 py-10">
        ...
        <div class="flex justify-between items-start gap-6 pb-5 mb-7"
            ...
            <div class="text-right shrink-0">
                ...
                <table style="border-collapse:collapse; margin-left:auto; min-width:200px;">
                    <thead>
                        <tr>
                            <th class="bg-ink" style="background:#111111 !important; color:#ffffff; padding:5px 16px; font-size:8px; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; border:1px solid #333; text-align:center;">
                                Quote #
                            </th>
                            <th class="bg-ink" style="background:#111111 !important; color:#ffffff; padding:5px 16px; font-size:8px; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; border:1px solid #333; text-align:center;">
                                Date
        ...
        <table style="border-collapse:collapse; width:100%; font-size:10.5px; margin-bottom:0;">
            <thead>
                <tr>
                    <th class="bg-ink" style="background:#111111 !important; color:#fff; border:1px solid #2a2a2a; padding:8px 6px; font-size:8px; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; text-align:center; width:50px;">
                        Qty.
                    </th>
                    <th class="bg-ink" style="background:#111111 !important; color:#fff; border:1px solid #2a2a2a; padding:8px 12px; font-size:8px; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; text-align:left;">
                        Description
                    </th>
                    <th class="bg-ink" style="background:#111111 !important; color:#fff; border:1px solid #2a2a2a; padding:8px 6px; font-size:8px; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; text-align:center; width:76px;">
                        Area
                    </th>
                    <th class="bg-ink" style="background:#111111 !important; color:#fff; border:1px solid #2a2a2a; padding:8px 12px; font-size:8px; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; text-align:right; width:100px;">
                        Unit Price
                    </th>
                    <th class="bg-ink" style="background:#111111 !important; color:#fff; border:1px solid #2a2a2a; padding:8px 12px; font-size:8px; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; text-align:right; width:100px;">
                        Amount
            ...
            <tbody>
                ...
                <tr style="background:#ffffff;">
                    {{-- QTY --}}
                    <td style="border:1px solid #e5e7eb; text-align:center; vertical-align:top; padding:10px 6px; font-weight:600; color:#222;">
                        {{ $item->pieces }}
                    </td>
                    ...
                    {{-- UNIT PRICE --}}
                    <td style="border:1px solid #e5e7eb; text-align:right; vertical-align:top; padding:10px 12px; color:#666;">
                        ₱{{ number_format($item->amount_per_piece, 2) }}
                    </td>

                    {{-- AMOUNT --}}
                    <td style="border:1px solid #e5e7eb; text-align:right; vertical-align:top; padding:10px 12px; font-weight:700; color:#111;">
                        ₱{{ number_format($item->total_amount, 2) }}
                    </td>
                </tr>
                @empty
                <tr style="background:#ffffff;">
                    <td colspan="5" style="border:1px solid #e5e7eb; padding:20px; text-align:center; color:#777;">
                        No approved quotation items yet.
                    </td>
                </tr>
                @endforelse
        ...
        <div class="flex justify-end mb-7">
            <table style="border-collapse:collapse; min-width:260px; border-top:none;">
                <tr>
                    <td class="bg-pale" style="background:#FAFAF8 !important; border:1px solid #e5e7eb; padding:7px 16px; font-size:8.5px; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; color:#777;">
                        Subtotal
                    </td>
                    <td style="border:1px solid #e5e7eb; padding:7px 16px; text-align:right; font-weight:600; color:#222; background:#fff;">
                        ₱{{ number_format($subtotal, 2) }}
                    </td>
                </tr>
                @if($discount > 0)
                <tr>
                    <td class="bg-pale" style="background:#FAFAF8 !important; border:1px solid #e5e7eb; padding:7px 16px; font-size:8.5px; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; color:#b91c1c;">
                        Discount
                    </td>
                    <td style="border:1px solid #e5e7eb; padding:7px 16px; text-align:right; font-weight:600; color:#b91c1c; background:#fff;">
                        − ₱{{ number_format($discount, 2) }}
                    </td>
                </tr>
                @endif
                <tr>
                    <td class="bg-gold" style="background:#B8860B !important; border:1px solid #8B6508; padding:9px 16px; font-family:'Poppins',serif; font-size:13px; font-weight:700; color:#fff;">
                        Total Quote
                    </td>
                    <td class="bg-gold" style="background:#B8860B !important; border:1px solid #8B6508; padding:9px 16px; text-align:right; font-size:14px; font-weight:800; color:#fff;">
        ...
        {{-- ══ DISCLAIMER ═════════════════════════════════════════════════════════ --}}
        <div style="text-align:center; font-style:italic; color:#aaa; font-size:9px; line-height:1.9; margin-bottom:24px; padding:10px 0; border-top:1px dashed #e5e7eb; border-bottom:1px dashed #e5e7eb;">
        ...
        {{-- ══ FOOTER ══════════════════════════════════════════════════════════════ --}}
        <div style="text-align:center; font-style:italic; color:#aaa; font-size:9px; margin-bottom:14px;">
