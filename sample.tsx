...
export default function ARMeasure({ onComplete }: Props) {
  ...
  const onSelect = useCallback(() => {
    ...
    if (count === 4) {
      clearPreviewLines();
      const modelDef =
        MODELS.find((m) => m.id === selectedModelIdRef.current) ?? MODELS[0];
  ...
  onXRFrameRef.current = (_t: number, frame: XRFrame) => {
    ...
    const reticle = reticleRef.current;
    if (!renderer || !scene || !camera || !reticle || !xrRefSpaceRef.current)
      return;
      ...
      >
        ...
        {sessionActive && (
          ...
          >
            ...
            >
              {loadingModel && (
                <span style={{ color: "#ffd740", fontSize: 11 }}>
                  ⏳ Loading…
                </span>
              )}
              <span>
              ...
              <span>
                ...
                <b
                  style={{
                    color:
                      pendingCount > 0 ? selectedModel.accentColor : "#fff",
                  }}
                >
                  {pendingCount}/4
                </b>
        ...
        {sessionActive && (
          ...
          >
            ...
            <div
              style={glass({
                fontSize: 11,
                color: hasUnconfirmed ? "#ffd740" : selectedModel.accentColor,
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      gap: 4,
                      padding: "6px 8px",
                      background: active ? m.accentColor + "22" : "transparent",
                      border: active
                  ...
                  >
                    ...
                    <span
                      style={{
                        ...
                        color: active ? m.accentColor : "#555",
                        fontFamily: "inherit",
            ...
            >
              ...
              <button
                onClick={clearAll}
                style={btn("#111", "rgba(255,255,255,0.1)", false)}
              >
                Clear
              </button>
              {hasUnconfirmed && (
                <button
                  ...
                  style={btn("#003322", "#00e5ff", false, "#00e5ff")}
                >
                  ✓ Confirm &amp; Next
                </button>
              )}
              <button onClick={endAR} style={btn("#1a0808", "#ff5252", false)}>
                Done
              </button>
            </div>
          </div>
      ...
      {showSummary && !sessionActive && (
        ...
        >
          ...
          >
            ...
            {summary.map((s, i) => {
              const model =
                MODELS.find((m) => m.label === s.modelLabel) ?? MODELS[0];
              return (
                <div
                  key={i}
                  style={{
      ...
      {!sessionActive && !showSummary && (
        ...
        >
          ...
          >
            ...
            {arSupported === true && "AR ready — tap Start AR to begin."}
            {arSupported === false &&
